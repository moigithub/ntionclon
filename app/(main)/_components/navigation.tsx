  ...
  return (
    <>
      <aside
        ref={sidebarRef}
        className={cn(
          'group/sidebar h-full bg-secondary overflow-y-auto relative flex w-60 flex-col z-[39]',
      ...
      >
        ...
        <div>
          ...
          <div
            ...
            onClick={resetWidth}
            className='border border-red-100 opacity-0 group-hover/sidebar:opacity-100 transition cursor-ew-resize absolute h-full w-1 bg-primary/10 right-0 top-0'
          />
        </div>
      </aside>
      <div
        ...
        className={cn(
          ...
          isResseting && 'transition-all ease-in-out',
